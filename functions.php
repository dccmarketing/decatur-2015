<?php
/**
 * City of Decatur 2015 functions and definitions
 *
...
if ( ! function_exists( 'decatur_2015_setup' ) ) :
/**
...
add_action( 'after_setup_theme', 'decatur_2015_setup' );
 ...
 */
function decatur_2015_content_width() {

	$GLOBALS['content_width'] = apply_filters( 'decatur_2015_content_width', 640 );

}
add_action( 'after_setup_theme', 'decatur_2015_content_width', 0 );
 ...
 */
function decatur_2015_widgets_init() {

	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'decatur-2015' ),
		'id'            => 'sidebar-1',
		'description'   => '',
